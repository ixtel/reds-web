...
function x(a,b,c){4!==b.length&&p(new sjcl.exception.invalid("invalid aes block size"));var d=a.d[c],e=b[0]^d[0],f=b[c?3:1]^d[1],g=b[2]^d[2];b=b[c?1:3]^d[3];var h,k,l,r=d.length/4-2,n,m=4,v=[0,0,0,0];h=a.n[c];a=h[0];var t=h[1],w=h[2],y=h[3],z=h[4];for(n=0;n<r;n++)h=a[e>>>24]^t[f>>16&255]^w[g>>8&255]^y[b&255]^d[m],k=a[f>>>24]^t[g>>16&255]^w[b>>8&255]^y[e&255]^d[m+1],l=a[g>>>24]^t[b>>16&255]^w[e>>8&255]^y[f&255]^d[m+2],b=a[b>>>24]^t[e>>16&255]^w[f>>8&255]^y[g&255]^d[m+3],m+=4,e=h,f=k,g=l;for(n=0;4>
n;n++)v[c?3&-n:n]=z[e>>>24]<<24^z[f>>16&255]<<16^z[g>>8&255]<<8^z[b&255]^d[m++],h=e,e=f,f=g,g=b,b=h;return v}
...
sjcl.codec.bytes={fromBits:function(a){var b=[],c=sjcl.bitArray.bitLength(a),d,e;for(d=0;d<c/8;d++)0===(d&3)&&(e=a[d/4]),b.push(e>>>24),e<<=8;return b},toBits:function(a){var b=[],c,d=0;for(c=0;c<a.length;c++)d=d<<8|a[c],3===(c&3)&&(b.push(d),d=0);c&3&&b.push(sjcl.bitArray.partial(8*(c&3),d));return b}};sjcl.hash.sha256=function(a){this.d[0]||this.I();a?(this.u=a.u.slice(0),this.q=a.q.slice(0),this.k=a.k):this.reset()};sjcl.hash.sha256.hash=function(a){return(new sjcl.hash.sha256).update(a).finalize()};
sjcl.hash.sha256.prototype={blockSize:512,reset:function(){this.u=this.R.slice(0);this.q=[];this.k=0;return this},update:function(a){"string"===typeof a&&(a=sjcl.codec.utf8String.toBits(a));var b,c=this.q=sjcl.bitArray.concat(this.q,a);b=this.k;a=this.k=b+sjcl.bitArray.bitLength(a);for(b=512+b&-512;b<=a;b+=512)A(this,c.splice(0,16));return this},finalize:function(){var a,b=this.q,c=this.u,b=sjcl.bitArray.concat(b,[sjcl.bitArray.partial(1,1)]);for(a=b.length+2;a&15;a++)b.push(0);b.push(Math.floor(this.k/
4294967296));for(b.push(this.k|0);b.length;)A(this,b.splice(0,16));this.reset();return c},R:[],d:[],I:function(){function a(a){return 0x100000000*(a-Math.floor(a))|0}var b=0,c=2,d;a:for(;64>b;c++){for(d=2;d*d<=c;d++)if(0===c%d)continue a;8>b&&(this.R[b]=a(Math.pow(c,0.5)));this.d[b]=a(Math.pow(c,1/3));b++}}};
function A(a,b){var c,d,e,f=b.slice(0),g=a.u,h=a.d,k=g[0],l=g[1],r=g[2],n=g[3],m=g[4],v=g[5],t=g[6],w=g[7];for(c=0;64>c;c++)16>c?d=f[c]:(d=f[c+1&15],e=f[c+14&15],d=f[c&15]=(d>>>7^d>>>18^d>>>3^d<<25^d<<14)+(e>>>17^e>>>19^e>>>10^e<<15^e<<13)+f[c&15]+f[c+9&15]|0),d=d+w+(m>>>6^m>>>11^m>>>25^m<<26^m<<21^m<<7)+(t^m&(v^t))+h[c],w=t,t=v,v=m,m=n+d|0,n=r,r=l,l=k,k=d+(l&r^n&(l^r))+(l>>>2^l>>>13^l>>>22^l<<30^l<<19^l<<10)|0;g[0]=g[0]+k|0;g[1]=g[1]+l|0;g[2]=g[2]+r|0;g[3]=g[3]+n|0;g[4]=g[4]+m|0;g[5]=g[5]+v|0;g[6]=
g[6]+t|0;g[7]=g[7]+w|0}
...
sjcl.prng=function(a){this.f=[new sjcl.hash.sha256];this.l=[0];this.J=0;this.w={};this.H=0;this.N={};this.T=this.h=this.m=this.ca=0;this.d=[0,0,0,0,0,0,0,0];this.i=[0,0,0,0];this.D=q;this.F=a;this.s=u;this.C={progress:{},seeded:{}};this.o=this.ba=0;this.A=1;this.B=2;this.Z=0x10000;this.L=[0,48,64,96,128,192,0x100,384,512,768,1024];this.$=3E4;this.Y=80};
...
this.d=sjcl.hash.sha256.hash(this.d.concat(e));this.D=new sjcl.cipher.aes(this.d);for(d=0;4>d&&!(this.i[d]=this.i[d]+1|0,this.i[d]);d++);}for(d=0;d<a;d+=4)0===(d+1)%this.Z&&B(this),e=C(this),c.push(e[0],e[1],e[2],e[3]);B(this);return c.slice(0,a)},setDefaultParanoia:function(a,b){0===a&&"Setting paranoia=0 will ruin your security; use it only for testing"!==b&&p("Setting paranoia=0 will ruin your security; use it only for testing");this.F=a},addEntropy:function(a,b,c){c=c||"user";var d,e,f=(new Date).valueOf(),
...
(new Date).valueOf()>this.T?this.B|this.A:this.A:this.h>=a?this.B|this.o:this.o},getProgress:function(a){a=this.L[a?a:this.F];return this.m>=a?1:this.h>a?1:this.h/a},startCollectors:function(){this.s||(this.c={loadTimeCollector:E(this,this.ea),mouseCollector:E(this,this.fa),keyboardCollector:E(this,this.da),accelerometerCollector:E(this,this.aa)},window.addEventListener?(window.addEventListener("load",this.c.loadTimeCollector,u),window.addEventListener("mousemove",this.c.mouseCollector,u),window.addEventListener("keypress",
this.c.keyboardCollector,u),window.addEventListener("devicemotion",this.c.accelerometerCollector,u)):document.attachEvent?(document.attachEvent("onload",this.c.loadTimeCollector),document.attachEvent("onmousemove",this.c.mouseCollector),document.attachEvent("keypress",this.c.keyboardCollector)):p(new sjcl.exception.bug("can't attach event")),this.s=s)},stopCollectors:function(){this.s&&(window.removeEventListener?(window.removeEventListener("load",this.c.loadTimeCollector,u),window.removeEventListener("mousemove",
this.c.mouseCollector,u),window.removeEventListener("keypress",this.c.keyboardCollector,u),window.removeEventListener("devicemotion",this.c.accelerometerCollector,u)):document.detachEvent&&(document.detachEvent("onload",this.c.loadTimeCollector),document.detachEvent("onmousemove",this.c.mouseCollector),document.detachEvent("keypress",this.c.keyboardCollector)),this.s=u)},addEventListener:function(a,b){this.C[a][this.ba++]=b},removeEventListener:function(a,b){var c,d,e=this.C[a],f=[];for(d in e)e.hasOwnProperty(d)&&
e[d]===b&&f.push(d);for(c=0;c<f.length;c++)d=f[c],delete e[d]},da:function(){F(1)},fa:function(a){sjcl.random.addEntropy([a.x||a.clientX||a.offsetX||0,a.y||a.clientY||a.offsetY||0],2,"mouse");F(0)},ea:function(){F(2)},aa:function(a){a=a.accelerationIncludingGravity.x||a.accelerationIncludingGravity.y||a.accelerationIncludingGravity.z;if(window.orientation){var b=window.orientation;"number"===typeof b&&sjcl.random.addEntropy(b,1,"accelerometer")}a&&sjcl.random.addEntropy(a,2,"accelerometer");F(0)}};
function D(a,b){var c,d=sjcl.random.C[a],e=[];for(c in d)d.hasOwnProperty(c)&&e.push(d[c]);for(c=0;c<e.length;c++)e[c](b)}function F(a){window&&window.performance&&"function"===typeof window.performance.now?sjcl.random.addEntropy(window.performance.now(),a,"loadtime"):sjcl.random.addEntropy((new Date).valueOf(),a,"loadtime")}function B(a){a.d=C(a).concat(C(a));a.D=new sjcl.cipher.aes(a.d)}function C(a){for(var b=0;4>b&&!(a.i[b]=a.i[b]+1|0,a.i[b]);b++);return a.D.encrypt(a.i)}
function E(a,b){return function(){b.apply(a,arguments)}}sjcl.random=new sjcl.prng(6);
a:try{var G,H,I,J;if(J="undefined"!==typeof module){var K;if(K=module.exports){var L;try{L=require("crypto")}catch(M){L=null}K=(H=L)&&H.randomBytes}J=K}if(J)G=H.randomBytes(128),G=new Uint32Array((new Uint8Array(G)).buffer),sjcl.random.addEntropy(G,1024,"crypto['randomBytes']");else if(window&&Uint32Array){I=new Uint32Array(32);if(window.crypto&&window.crypto.getRandomValues)window.crypto.getRandomValues(I);else if(window.msCrypto&&window.msCrypto.getRandomValues)window.msCrypto.getRandomValues(I);
...
sjcl.ecc.basicKey={publicKey:function(a,b){this.g=a;this.j=a.r.bitLength();this.v=b instanceof Array?a.fromBits(b):b;this.get=function(){var a=this.v.toBits(),b=sjcl.bitArray.bitLength(a),e=sjcl.bitArray.bitSlice(a,0,b/2),a=sjcl.bitArray.bitSlice(a,b/2);return{x:e,y:a}}},secretKey:function(a,b){this.g=a;this.j=a.r.bitLength();this.t=b;this.get=function(){return this.t.toBits()}}};
...
sjcl.ecc.elGamal={generateKeys:sjcl.ecc.basicKey.generateKeys("elGamal"),publicKey:function(a,b){sjcl.ecc.basicKey.publicKey.apply(this,arguments)},secretKey:function(a,b){sjcl.ecc.basicKey.secretKey.apply(this,arguments)}};sjcl.ecc.elGamal.publicKey.prototype={kem:function(a){a=sjcl.bn.random(this.g.r,a);var b=this.g.G.mult(a).toBits();return{key:sjcl.hash.sha256.hash(this.v.mult(a).toBits()),tag:b}}};
sjcl.ecc.elGamal.secretKey.prototype={unkem:function(a){return sjcl.hash.sha256.hash(this.g.fromBits(a).mult(this.t).toBits())},dh:function(a){return sjcl.hash.sha256.hash(a.v.mult(this.t).toBits())}};sjcl.ecc.ecdsa={generateKeys:sjcl.ecc.basicKey.generateKeys("ecdsa")};sjcl.ecc.ecdsa.publicKey=function(a,b){sjcl.ecc.basicKey.publicKey.apply(this,arguments)};
sjcl.ecc.ecdsa.publicKey.prototype={verify:function(a,b,c){sjcl.bitArray.bitLength(a)>this.j&&(a=sjcl.bitArray.clamp(a,this.j));var d=sjcl.bitArray,e=this.g.r,f=this.j,g=sjcl.bn.fromBits(d.bitSlice(b,0,f)),d=sjcl.bn.fromBits(d.bitSlice(b,f,2*f)),h=c?d:d.inverseMod(e),f=sjcl.bn.fromBits(a).mul(h).mod(e),h=g.mul(h).mod(e),f=this.g.G.mult2(f,h,this.v).x;if(g.equals(0)||d.equals(0)||g.greaterEquals(e)||d.greaterEquals(e)||!f.equals(g)){if(c===q)return this.verify(a,b,s);p(new sjcl.exception.corrupt("signature didn't check out"))}return s}};
sjcl.ecc.ecdsa.secretKey=function(a,b){sjcl.ecc.basicKey.secretKey.apply(this,arguments)};sjcl.ecc.ecdsa.secretKey.prototype={sign:function(a,b,c,d){sjcl.bitArray.bitLength(a)>this.j&&(a=sjcl.bitArray.clamp(a,this.j));var e=this.g.r,f=e.bitLength();d=d||sjcl.bn.random(e.sub(1),b).add(1);b=this.g.G.mult(d).x.mod(e);a=sjcl.bn.fromBits(a).add(b.mul(this.t));c=c?a.inverseMod(e).mul(d).mod(e):a.mul(d.inverseMod(e)).mod(e);return sjcl.bitArray.concat(b.toBits(f),c.toBits(f))}};
